...
interface RefactoredAdminFlashSalesManagementProps {
  onRefresh?: () => void;
}

export const RefactoredAdminFlashSalesManagement: React.FC<RefactoredAdminFlashSalesManagementProps> = ({ 
  onRefresh 
}) => {
  // Core state
...
export default RefactoredAdminFlashSalesManagement;
