...
// Removed legacy standardClasses helper – direct utilities now
...
const PaymentStatusPage: React.FC = () => {
  ...
  if (!order) {
    return (
  <div className="min-h-screen flex items-center justify-center bg-black text-white px-4 with-bottom-nav">
  ...
  return (
  <div className="min-h-screen bg-black text-white with-bottom-nav">
  <div className="w-full max-w-7xl mx-auto px-4">
        <div className="bg-black border border-gray-700 rounded-2xl p-6 sm:p-8 shadow-lg">
          ...
          <div className="space-y-4 mb-8">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
              <span className="text-white/70 text-sm">Total Pembayaran:</span>
            ...
            <div className="space-y-2 text-sm">
              {order.payment_channel && (
                <div className="flex justify-between">
                  <span className="text-white/70">Metode:</span>
              ...
              {order.paid_at && (
                <div className="flex justify-between">
                  <span className="text-white/70">Dibayar:</span>
